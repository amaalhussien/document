		...
		<table class="main-table text-center table table-bordered" >
			...
			while($row=mysqli_fetch_assoc($result)){
					...
					echo "<tr>";
						...
						echo "<td>
							<a href='employee.php?do=Edit&id_dep=".$row['stage_id'] . "' class='btn btn-success' ><i class='fa fa-edit'></i> Edit</a>
							<a href='employee.php?do=Delete&id_dep=" . $row['stage_id'] . "' class='btn btn-danger confirm s><i class='fa fa-close'></i> Delete </a>";
					  echo "</td>";
					 echo "</tr>";
				}
			?>
